    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 8,
          name: 'Python',
          imageUrl: 'https://avatars.githubusercontent.com/u/50630501?s=80&v=4',
          status: 'Advance'
        },
        {
          id: 9,
      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Saya seorang mahasiswa di Universitas Trunojoyo Madura yang tumbuh dan berkembang di
            pulau Madura. Dengan ketertarikan saya pada dunia teknologi, saya mengejar kedua minat saya sebagai seorang
            programmer dan desainer. Melalui perjalanan pendidikan saya, saya terus mengasah keterampilan dan kreativitas
            dalam bidang ini. Selamat datang di dunia saya, di mana coding dan desain bertemu untuk menciptakan solusi
            yang inovatif!
          </p>
